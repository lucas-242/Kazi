...
// in my_services/test/lib/views/add_services/add_services_cubit_test.dart.
...
import 'package:my_services/models/app_user.dart' as _i8;
import 'package:my_services/models/service.dart' as _i6;
import 'package:my_services/models/service_type.dart' as _i2;
...
import 'package:my_services/repositories/services_repository/services_repository.dart'
    as _i5;
import 'package:my_services/services/auth_service/auth_service.dart' as _i7;
...
class MockServiceTypeRepository extends _i1.Mock
  ...
  @override
  _i4.Future<List<_i2.ServiceType>> get(String? userId) => (super.noSuchMethod(
        Invocation.method(
          #get,
          [userId],
        ),
